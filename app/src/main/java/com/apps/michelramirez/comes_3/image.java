    ...
    public void ImageUploadToServerFunction(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPreExecute() {
                ...
                progressDialog = ProgressDialog.show(image.this,"Subiendo imagen...","Por favor espere",false,false);
            }
            ...
            protected void onPostExecute(String string1) {
                ...
                Toast.makeText(image.this,string1,Toast.LENGTH_LONG).show();
            ...
            protected String doInBackground(Void... params) {
              ...
              //  HashMapParams.put(ImageName, GetImageNameEditText);
                ...
                HashMapParams.put("idProducto", String.valueOf(idProducto));
